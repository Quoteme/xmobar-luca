...
/* package xmobar-luca-0.1.0.0 */
#ifndef VERSION_xmobar_luca
#define VERSION_xmobar_luca "0.1.0.0"
#endif /* VERSION_xmobar_luca */
#ifndef MIN_VERSION_xmobar_luca
#define MIN_VERSION_xmobar_luca(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_xmobar_luca */
...
#define CURRENT_COMPONENT_ID "xmobar-luca-0.1.0.0-inplace-xmobar-luca"
